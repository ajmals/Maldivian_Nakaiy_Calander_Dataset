...
The data was manually extracted and compiled from the book "NAKAIY" by Hassan Ahmed Maniku. This system has roots in ancient Indian (Indus Valley) and Sinhala traditions, as discussed in the book.
...
- **PDF Reference:** A cropped PDF of the book is included in this repo as `NAKAIYY_HASSAN_AHMED_MANIK_VANAVARU_NO_2_19_MARCH_1989_cropped.pdf` for context (pages 1-5 shown; full book has 13 pages).
- **Images:** Scans from the book, including cover (`book_cover.jpg`), title page (`title_page.jpg`), author's note (`authors_note.jpg`), and introduction (`introduction_pages.jpg`).
